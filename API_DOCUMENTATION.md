...
- **Leave Project (`POST /api/projects/{id}/leave`)**
  ...
  - **Access Control:** Restricted to project participants (Owners cannot leave their own projects).
  - **Response (200 OK):**
  ...
  - **Error Responses:**
    - `400 Bad Request`: Project identifier is invalid, the user is the project Owner (who must delete the project instead), or the user is not a participant of the project.
    - `404 Not Found`: Project target not found.
